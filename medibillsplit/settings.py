"""
Django settings for medibillsplit project.
...
SECRET_KEY = 'django-insecure-y_)e&n#x!f#k@pgaq0@$cd=@$#qbm1@7#(&@&7th$2n3z6_5*_'
...
WSGI_APPLICATION = 'medibillsplit.wsgi.application'
